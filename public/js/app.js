  ...
  methods: {
    ...
    handleResults: function handleResults() {
      ...
      this.questions.forEach(function (question, questionNumber) {
        var yourAnswers = _this.answers[questionNumber];
  ...
  return _c("div", [
    _vm.introStage
      ? _c("div", [
          ...
          _vm._v(" "),
          _c("button", { on: { click: _vm.startQuiz } }, [_vm._v("START!")])
        ])
      : _vm._e(),
    _vm._v(" "),
    _vm.questionStage
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "max-w-md rounded overflow-hidden shadow-lg p-1 m-1" },
    [
        ...
        ? _c(
            ...
            [
              _c(
                ...
                _vm._l(_vm.answer, function(element) {
                  return _c(
                    "div",
                    {
                      key: element,
      ...
      _c("span", { staticClass: "flex justify-end" }, [
        _c(
          "button",
          { staticClass: "blue right", on: { click: _vm.submitAnswer } },
          [_vm._v("Antwoord")]
        )
      ])
    ]
